      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-300 border-0 border bg-gradient-to-br red from-card to-card/50">
                <div className={`relative ${project.featured ? "md:flex" : ""}`}>
                  ...
                  >
                    ...
                    <h3 className="group-hover:text-primary text-2xl font-semibold mb-2 transition-colors duration-300">
                      {project.title}
                    </h3>
