                ...
                <div className={`relative ${project.featured ? "md:flex" : ""}`}>
                  <div className={`relative overflow-hidden ${project.featured ? "md:w-1/2" : ""}`}>
                    <Image
                      ...
                      width={600}
                      height={400}
                      className="w-full h-64 md:h-70 object-cover transition-transform duration-500 group-hover:scale-110"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-80 transition-opacity duration-400" />
                  </div>
                  ...
                  >
                    <div className="flex flex-wrap gap-3 mb-3">
                      {project.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-3 py-2 bg-primary/30 text-primary rounded-full text-sm font-medium"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <h3 className="group-hover:text-primaryl font-semibold mb-4 transition-colors">
                      {project.title}
                    </h3>
