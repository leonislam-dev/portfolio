      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-400 border bg-gradient-to-br from-card to-card/50">
                <div className={`relative ${project.featured ? "md:flex" : ""}`}>
                  <div className={`relative overflow-hidden ${project.featured ? "md:w-1/3" : ""}`}>
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent  group-hover:opacity-100 transition-opacity duration-300" />
                  </div>
